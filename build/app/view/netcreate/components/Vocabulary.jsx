      ...
      return (
        <div className="help"
          ...
          <div hidden={!this.state.isExpanded}
            ...
            <dt>Directed or undirected ties</dt>
            ...
            <dt>Graph</dt>
            <dd>a graphic representation of the nodes and links between them. <em><strong>Similar terms include:</strong> sociogram, visualization</em></dd>
