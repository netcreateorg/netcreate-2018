  ...
  SessionEdit({ match, location }) {
    ...
    if (decoded) {
      ...
      return (
        <div>
          <p>
            <small>matching subroute: [{token}]</small>
            <br />
            <span style={{ color: 'green' }}>
              <small>valid token: groupID {decoded.groupId}</small>
            </span>
          </p>
        </div>
      );
        ...
        <div>
          <p>
            ...
            <span style={{ color: 'red' }}>
              <small>COULD NOT DECODE TO VALID GROUP ID</small>
            </span>
          </p>
        </div>
      );
  ...
  render() {
    return (
      <div id="fdshell" style={{ padding: '10px' }}>
        ...
        <Route
          path={`${this.props.match.path}/edit/:token`}
          component={this.SessionEdit}
        />
